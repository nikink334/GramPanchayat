...
{
    public partial class TaxReprot : Form
    {
        ...
        private void TaxReprot_Load(object sender, EventArgs e)
        {
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            using (OleDbCommand cmd = new OleDbCommand("SELECT * FROM PropertyTax WHERE Pro_Tax_Id LIKE ?", conn))
            {
            ...
            ReportDataSource rds = new ReportDataSource("PropertyTax", dt);
        ...
        private void btn_reportAll_Click(object sender, EventArgs e)
        {
            ...
            // Create an SQL command for the query
            using (OleDbCommand cmd = new OleDbCommand("SELECT * FROM PropertyTax ", conn))
            {
            ...
            // Create a ReportDataSource with the DataTable
            ReportDataSource rds = new ReportDataSource("TaxReport", dt);
